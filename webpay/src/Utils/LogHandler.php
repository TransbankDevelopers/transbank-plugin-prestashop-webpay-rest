...
class LogHandler
{
    ...
    public function __construct($ecommerce = 'prestashop', $days = 7, $weight = '2MB')
    {
        $this->timestamp = null;
    ...
    {
        return json_encode($this->getResumeBase(), JSON_PRETTY_PRINT); // NOTE: eliminar el pretty print antes de pasar a produccion
    }
