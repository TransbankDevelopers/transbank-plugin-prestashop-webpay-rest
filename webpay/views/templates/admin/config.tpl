...
<body onload="">
	<div>
		...
		<form action="{$post_url|escape:'htmlall':'UTF-8'}" method="post" style="clear: both; margin-top: 10px;">
            ...
            <div class="margin-form"><input type="text" size="90" id="apiKey" name="apiKey" value="{$data_apikey|escape:'htmlall':'UTF-8'}"/></div>
			...
			<div class="margin-form">
				<select name="ambient" onChange="
					...
					<option value="TEST" {if $data_ambient eq "TEST"}selected{/if}>Integracion</option>
					<option value="LIVE" {if $data_ambient eq "LIVE"}selected{/if}>Produccion</option>
				</select>
			</div>
			<br/>
						...
						<div class="tab-content">
							...
							<div id="info" class="tab-pane fade in active">
								...
								<form method="post" action="../modules/webpay/libwebpay/CreatePdf.php" target="_blank">
									...
									<input type="hidden" name="apiKey" value="{$data_apikey}">
        ...
        <script type="text/javascript">
			...
			function cargaDatosIntegracion(){
				...
				document.getElementById('apiKey').value = "{$data_apikey_init|escape:'htmlall':'UTF-8'}";
			}
